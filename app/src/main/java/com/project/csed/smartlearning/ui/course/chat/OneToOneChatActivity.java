...
import com.project.csed.smartlearning.adapters.PrivateMessageAdapter;
import com.project.csed.smartlearning.models.PrivateMessagePOJO;
...
public class OneToOneChatActivity extends AppCompatActivity {
    ...
    private void initRecyclerView() {
        ...
        adapter=new PrivateMessageAdapter(getApplicationContext(),messageList){
            ...
            if (  messageList.get(i).getSenderName().equals(senderName))
            {
